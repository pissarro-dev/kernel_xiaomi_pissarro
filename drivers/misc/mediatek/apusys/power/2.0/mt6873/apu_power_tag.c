...
static void
probe_apupwr_pwr(void *data, unsigned int vvpu, unsigned int vmdla,
	unsigned int vcore, unsigned int vsram, unsigned int dsp1_freq,
	...
	unsigned long long id)
{
	...
	t.d.pwr.vcore = vcore;
	t.d.pwr.vsram = vsram;
	t.d.pwr.dsp1_freq = dsp1_freq;
	t.d.pwr.dsp2_freq = dsp2_freq;
	t.d.pwr.dsp5_freq = dsp5_freq;
	t.d.pwr.dsp_freq = dsp_freq;
	t.d.pwr.ipuif_freq = ipuif_freq;
	t.d.pwr.id = id;
...
static void apupwr_tag_seq_pwr(struct seq_file *s, struct apupwr_tag *t)
{
	seq_printf(s,
		...
		t->d.pwr.vvpu, t->d.pwr.vmdla,
		t->d.pwr.vcore, t->d.pwr.vsram);

	apu_tags_seq_time(s, t->d.pwr.id);

	seq_printf(s,
		",F_v0=%d,F_v1=%d,F_m0=%d,F_conn=%d,F_ipuif=%d\n",
		t->d.pwr.dsp1_freq, t->d.pwr.dsp2_freq,
		t->d.pwr.dsp5_freq, t->d.pwr.dsp_freq,
		t->d.pwr.ipuif_freq);
}
...
static void apupwr_tag_seq_rpc(struct seq_file *s, struct apupwr_tag *t)
{
	...
	t->d.rpc.vcore_cg_stat, t->d.rpc.conn_cg_stat);
