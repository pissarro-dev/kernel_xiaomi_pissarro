...
#include "imx355sunnymipiraw_Sensor.h"
...
#if USE_BURST_MODE
static kal_uint16 imx355sunny_table_write_cmos_sensor(
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX355SUNNY_SENSOR_ID,
	...
	.custom1 = { /* same as pre */
		...
		.mipi_pixel_rate = 206400000,
		.max_framerate = 300, /* 24fps */
	},

	.custom2 = {//1600x900@30fps, 2x2 binning
		.pclk = 201600000,
		.linelength = 1836,
		.framelength = 3660,
		.startx = 0,
	...
	.gain_step = 1,
	.gain_type = 3,
	.max_frame_length = 2258000, //30.8s
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	...
	{3280, 2464, 0,   0,   3280, 2464, 3280, 2464, 0, 0, 3280, 2464,  0,  0, 3280, 2464}, /* hs_video 240fps*/
	{3280, 2464, 0,   0,   3280, 2464, 3280, 2464, 0, 0, 3280, 2464,  0,  0, 3280, 2464}, /* slim video same as pre*/
	{3280, 2464, 440, 332, 2400, 1800, 2400, 1800, 0, 0, 2400, 1800,  0,  0, 2400, 1800}, /* custom1 2400x1800@30fps*/
	{3280, 2464,  40, 332, 3200, 1800, 1600,  900, 0, 0, 1600,  900,  0,  0, 1600,  900}, /* custom2 1600x900@120fps*/
	{3280, 2464, 440, 332, 2400, 1800, 2400, 1800, 0, 0, 2400, 1800,  0,  0, 2400, 1800}, /* custom3 preview@24fps*/
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[7] = {
	...
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x0CD0, 0x09A0, 0x00, 0x00, 0x00, 0x00,
...
#if ENABLE_PDAF
static void imx355sunny_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx355sunny_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static kal_uint32 imx355sunny_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	return ERROR_NONE;
}
/*
static kal_uint16 imx355sunny_feedback_awbgain[] = {
	0x0b90, 0x00,
	0x0b91, 0x01,
	0x0b92, 0x00,
	0x0b93, 0x01,
...
static void feedback_awbgain(kal_uint32 r_gain, kal_uint32 b_gain)
{
	...
	imx355sunny_feedback_awbgain[1] = r_gain_int;
	imx355sunny_feedback_awbgain[3] = (
		((r_gain*100) / 512) - (r_gain_int * 100)) * 2;
	imx355sunny_feedback_awbgain[5] = b_gain_int;
	imx355sunny_feedback_awbgain[7] = (
		((b_gain * 100) / 512) - (b_gain_int * 100)) * 2;
	imx355sunny_table_write_cmos_sensor(imx355sunny_feedback_awbgain,
		sizeof(imx355sunny_feedback_awbgain)/sizeof(kal_uint16));
}
*/
static void imx355sunny_set_lsc_reg_setting(
...
static kal_uint16 imx355sunny_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
#endif
static kal_uint16 imx355sunny_init_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x4348, 0x16,
	0x4350, 0x19,
...
static kal_uint16 imx355sunny_capture_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 imx355sunny_preview_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 imx355sunny_normal_video_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 imx355sunny_slim_video_setting[] = {

};

static kal_uint16 imx355sunny_hs_video_setting[] = {

};

static kal_uint16 imx355sunny_custom1_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 imx355sunny_custom2_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
static void sensor_init(void)
{
	...
	imx355sunny_table_write_cmos_sensor(imx355sunny_init_setting,
		sizeof(imx355sunny_init_setting)/sizeof(kal_uint16));
...
{
	LOG_INF("%s +\n", __func__);
	imx355sunny_table_write_cmos_sensor(imx355sunny_preview_setting,
		sizeof(imx355sunny_preview_setting)/sizeof(kal_uint16));
	LOG_INF("%s -\n", __func__);
} /* preview_setting */
...
{
	LOG_INF("%s fps E! currefps:%d +\n", __func__, currefps);
	/*************MIPI output setting************/
	imx355sunny_table_write_cmos_sensor(imx355sunny_capture_setting,
		sizeof(imx355sunny_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	imx355sunny_table_write_cmos_sensor(imx355sunny_normal_video_setting,
		sizeof(imx355sunny_normal_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}

static void hs_video_setting(void)
{
	LOG_INF("%s E! currefps 240\n", __func__);
	imx355sunny_table_write_cmos_sensor(imx355sunny_hs_video_setting,
		sizeof(imx355sunny_hs_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}

static void slim_video_setting(void)
{
	LOG_INF("%s E! 4624*3472@30fps\n", __func__);
	imx355sunny_table_write_cmos_sensor(imx355sunny_slim_video_setting,
		sizeof(imx355sunny_slim_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}

static void custom1_setting(void)
{
	LOG_INF("%s 4624*3472@30 E! currefps\n", __func__);
	/*************MIPI output setting************/
	imx355sunny_table_write_cmos_sensor(imx355sunny_custom1_setting,
		sizeof(imx355sunny_custom1_setting)/sizeof(kal_uint16));
	LOG_INF("X");
}

static void custom2_setting(void)
{
	LOG_INF("%s 4M@120fps E! currefps\n", __func__);
	/*************MIPI output setting************/

	imx355sunny_table_write_cmos_sensor(imx355sunny_custom2_setting,
		sizeof(imx355sunny_custom2_setting)/sizeof(kal_uint16));
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx355sunny_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx355sunny_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
...
break;
	...
	case SENSOR_FEATURE_GET_VC_INFO:
		...
		case MSDK_SCENARIO_ID_CUSTOM3:
			...
			break;
		default:
			LOG_INF("error: get wrong vc_INFO id = %d",
			*feature_data_32);
			break;
		}
	break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		imx355sunny_set_lsc_reg_setting(index, feature_data_16,
