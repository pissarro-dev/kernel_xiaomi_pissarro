...
#define S5KHM2SD_OFILM_LOG_INF(format, args...) pr_info(LOG_TAG "[%s] " format, __func__, ##args)
#define S5KHM2SD_OFILM_LOG_DBG(format, args...) pr_debug(LOG_TAG "[%s] " format, __func__, ##args)
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KHM2SD_OFILM_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
static void sensor_init(void)
{
	...
	// Global
	table_write_cmos_sensor(s5khm2sd_ofilm_init_setting,
			sizeof(s5khm2sd_ofilm_init_setting) / sizeof(kal_uint16));
}	/*	sensor_init  */

static void preview_setting(void)
{
	S5KHM2SD_OFILM_LOG_DBG("write sensor previews setting\n");
	table_write_cmos_sensor(s5khm2sd_ofilm_preview_setting,
		sizeof(s5khm2sd_ofilm_preview_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
static void normal_video_setting(void)
{
	...
	table_write_cmos_sensor(s5khm2sd_ofilm_normal_video_setting,
		sizeof(s5khm2sd_ofilm_normal_video_setting) / sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(s5khm2sd_ofilm_hs_video_setting,
		sizeof(s5khm2sd_ofilm_hs_video_setting) / sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	table_write_cmos_sensor(s5khm2sd_ofilm_slim_video_setting,
		sizeof(s5khm2sd_ofilm_slim_video_setting) / sizeof(kal_uint16));
}
...
static void custom1_setting(void)
{
	...
	table_write_cmos_sensor(s5khm2sd_ofilm_custom1_setting,
			sizeof(s5khm2sd_ofilm_custom1_setting) / sizeof(kal_uint16));
}
...
static void custom2_setting(void)
{
	...
	table_write_cmos_sensor(s5khm2sd_ofilm_custom2_setting,
			sizeof(s5khm2sd_ofilm_custom2_setting) / sizeof(kal_uint16));
}

static void custom3_setting(void)
{
	S5KHM2SD_OFILM_LOG_DBG("E\n");
	table_write_cmos_sensor(s5khm2sd_ofilm_custom3_setting,
			sizeof(s5khm2sd_ofilm_custom3_setting) / sizeof(kal_uint16));
}
...
{
	S5KHM2SD_OFILM_LOG_DBG("E!\n");
	table_write_cmos_sensor(s5khm2sd_ofilm_custom5_setting,
		sizeof(s5khm2sd_ofilm_custom5_setting) / sizeof(kal_uint16));
}
...
UINT32 S5KHM2SD_OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
