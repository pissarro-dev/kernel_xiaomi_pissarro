 ...
 *=====================================================
 ************************************************************************/
#define PFX "IMX471_SUNNY_camera_sensor"
...
#include "imx471_sunny_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = IMX471_SUNNY_SENSOR_ID,
	...
	.slim_video = {/*60 FPS video data rate 1836 Mbps/lane */
		.pclk = 278000000,
		.linelength = 2560,
		.framelength = 1808,
		.startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{4656, 3496, 408, 668, 3840, 2160, 1920, 1080, 0000, 0000, 1920, 1080, 0, 0, 1920, 1080},	/*hs-video*/
	{4656, 3496,   8, 444, 4640, 2608, 2320, 1304, 0000, 0000, 2320, 1304, 0, 0, 2320, 1304},	/*slim video*/
};
...
#endif
static kal_uint16 imx471_sunny_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_imx471_sunny[] = {
...
{
	pr_debug("02E\n");
	imx471_sunny_table_write_cmos_sensor(addr_data_pair_init_imx471_sunny,
	    sizeof(addr_data_pair_init_imx471_sunny)/sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_preview_imx471_sunny[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx471_sunny_table_write_cmos_sensor(
	addr_data_pair_preview_imx471_sunny,
	sizeof(addr_data_pair_preview_imx471_sunny) / sizeof(kal_uint16));
} /* preview_setting */


kal_uint16 addr_data_pair_capture_imx471_sunny[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx471_sunny_table_write_cmos_sensor(addr_data_pair_capture_imx471_sunny,
		sizeof(addr_data_pair_capture_imx471_sunny) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_video_imx471_sunny[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	pr_debug("E! %s:%d\n", __func__, currefps);
	imx471_sunny_table_write_cmos_sensor(addr_data_pair_video_imx471_sunny,
		sizeof(addr_data_pair_video_imx471_sunny) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_imx471_sunny[] = {	/*720 120fps */
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx471_sunny_table_write_cmos_sensor(addr_data_pair_hs_video_imx471_sunny,
		sizeof(addr_data_pair_hs_video_imx471_sunny) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_imx471_sunny[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx471_sunny_table_write_cmos_sensor(addr_data_pair_slim_video_imx471_sunny,
		sizeof(addr_data_pair_slim_video_imx471_sunny) / sizeof(kal_uint16));
}
...
static kal_uint32 open(void)
{
	...
	pr_debug("IMX471_SUNNY, MIPI 4LANE\n");
	pr_debug(
...
static kal_uint32 imx471_sunny_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
...
static void check_stream_is_on(void)
{
	...
	for (i = 0; i < timeout; i++) {
		...
		if (framecnt != 0xFF) {
			pr_debug("IMX471_SUNNY stream is on, %d \\n", framecnt);
			break;
		}
		pr_debug("IMX471_SUNNY stream is not on %d \\n", framecnt);
		mdelay(1);
	}
}
...
static kal_uint32 exposure_for_gyroscope()
{
	...
	pr_debug("gyroscope vendor name:%s, exposure time:%d", hubinfo.name, exposure);
	return exposure;
}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx471_sunny_awb_gain(pSetSensorAWB);
		break;
...
UINT32 IMX471_SUNNY_MIPI_RAW_SensorInit(
			struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* IMX471_SUNNY_MIPI_RAW_SensorInit */
