...
#include "imx471_ofilm_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = IMX471_OFILM_SENSOR_ID,
...
static kal_uint32 exposure_for_gyroscope()
{
	...
	pr_err("gyroscope vendor name:%s, exposure time:%d", hubinfo.name, exposure);
	return exposure;
}
...
UINT32 IMX471_OFILM_MIPI_RAW_SensorInit(
