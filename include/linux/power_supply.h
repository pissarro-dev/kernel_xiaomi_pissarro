...
enum {
	...
	POWER_SUPPLY_CHARGE_TYPE_NOT_CHARGING = 0,
	POWER_SUPPLY_CHARGE_TYPE_PRECHARGE,
	POWER_SUPPLY_CHARGE_TYPE_FAST,
	POWER_SUPPLY_CHARGE_TYPE_TERMINATION,
#else
	POWER_SUPPLY_CHARGE_TYPE_UNKNOWN = 0,
...
enum {
	POWER_SUPPLY_PD_NONE = 0,
	POWER_SUPPLY_PD_FIXED,
	POWER_SUPPLY_PD_PD30,
	POWER_SUPPLY_PD_APDO,
};
...
enum power_supply_property {
	...
	POWER_SUPPLY_PROP_PFM_OTG_DIS,
	POWER_SUPPLY_PROP_PFM_FWD_DIS,
	POWER_SUPPLY_PROP_DIS_OTG_OOA,
	POWER_SUPPLY_PROP_DIS_FWD_OOA,
	/* bq25890 */
...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_USB_HVDCP_3,		/* QC3 */
	POWER_SUPPLY_TYPE_USB_HVDCP_3_PLUS,	/* QC35 */
	POWER_SUPPLY_TYPE_WIRELESS,		/* Wireless Charger */
#ifndef CONFIG_PISSARRO_CHARGER
	POWER_SUPPLY_TYPE_BMS,			/* Battery Monitor System */
	POWER_SUPPLY_TYPE_CHARGER_IDENTIFY,	/* Charger type identify System */
#ifdef CONFIG_AGATE_CHARGER
